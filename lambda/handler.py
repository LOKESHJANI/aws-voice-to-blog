...
def lambda_handler(event, context):
    ...
    # Step 5 — Build the blog writing prompt
...
{transcript_text}"""
    ...
    # Step 6 — Call Amazon Nova Lite to generate the blog post
    ...
    print("Blog post generated by Nova Lite")

    # Step 7 — Save the blog post HTML to S3 output bucket
